        ...
        React.createElement('div', { className: "p-4 h-full overflow-y-auto" },
             ...
             React.createElement('div', { className: "mb-8" },
                ...
                React.createElement('div', { className: "bg-black/50 p-8 rounded-lg flex justify-center items-center" },
                    React.createElement('div', { className: "bg-layer-01/90 backdrop-blur-sm rounded-lg shadow-lg p-1 flex flex-col gap-1" },
                        ...
                        React.createElement('div', { className: "h-px bg-border-strong/50 my-1 mx-1" }),
