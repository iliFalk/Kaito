...
export const Icon = ({ name, className }) => {
  const icons = {
    ...
    Cog6ToothIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:"1.5", stroke:"currentColor"}, 
        React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M12 2L20.66 7V17L12 22L3.34 17V7L12 2Z"}), 
    ...
    LanguageIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"m10.5 21 5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 0 1 6-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C11.176 10.658 7.69 15.08 3 17.502m9.334-12.138c.896.061 1.785.147 2.666.257m-4.589 8.495a18.023 18.023 0 0 1-3.827-5.802"}))
    ),
    CheckCircleIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"}))
    ),
    QuestionMarkCircleIcon: (props) => (
    ...
    Bars3Icon: (props) => (
      React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"}))
    ),
    PaperClipIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"}))
    ),
    PaperAirplaneIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5"}))
    ),
    ClipboardDocumentIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M15.666 3.888A2.25 2.25 0 0 0 13.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a2.25 2.25 0 0 1-2.25 2.25H9a2.25 2.25 0 0 1-2.25-2.25v0c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 0 1-2.25 2.25H6.75A2.25 2.25 0 0 1 4.5 19.5V6.257c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 0 1 1.927-.184"}))
    ),
    DocumentDuplicateIcon: (props) => (
    ...
    ArrowPathIcon: (props) => (
       React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 11.667 0l3.181-3.183m-4.991-2.696h4.992v.001M21.015 4.356v4.992m0 0h-4.992m4.992 0-3.181-3.183a8.25 8.25 0 0 0-11.667 0L2.985 9.348"}))
    ),
    ChatBubbleBottomCenterPlusIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"}))
    ),
    ClockIcon: (props) => (
        React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"}))
    ),
    CpuChipIcon: (props) => (
    ...
    ArrowLeftIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, React.createElement('path', {strokeLinecap:'round', strokeLinejoin:'round', d:"M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18"}))
    ),
    EyeIcon: (props) => (
      React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", fill:"none", viewBox:"0 0 24 24", strokeWidth:1.5, stroke:"currentColor"}, 
...
export const GoogleIcon = (props) => (
  React.createElement('svg', {...props, viewBox:"0 0 24 24", xmlns:"http://www.w3.org/2000/svg"}, 
    React.createElement('path', {d:"M21.35,11.1H12.18V13.83H18.69C18.36,17.64 15.19,19.27 12.19,19.27C8.36,19.27 5,16.25 5,12C5,7.9 8.2,5 12,5C14.6,5 16.1,6.2 17.1,7.2L19.2,5.2C17.5,3.5 15.2,2 12,2C6.4,2 2,6.5 2,12C2,17.5 6.4,22 12,22C17.6,22 21.7,18.2 21.7,12.3C21.7,11.7 21.5,11.4 21.35,11.1Z", fill:"#4285F4"}),
    React.createElement('path', {d:"M21.35,11.1H12.18V13.83H18.69C18.36,17.64 15.19,19.27 12.19,19.27C8.36,19.27 5,16.25 5,12C5,7.9 8.2,5 12,5C14.6,5 16.1,6.2 17.1,7.2L19.2,5.2C17.5,3.5 15.2,2 12,2C6.4,2 2,6.5 2,12C2,17.5 6.4,22 12,22C17.6,22 21.7,18.2 21.7,12.3C21.7,11.7 21.5,11.4 21.35,11.1Z", fillOpacity:"0", stroke:"#4285F4", strokeWidth:"0.5"})
  )
);

export const PerplexityIcon = (props) => (
    React.createElement('svg', {...props, viewBox:"0 0 24 24", fill:"none", xmlns:"http://www.w3.org/2000/svg"},
        ...
        React.createElement('path', {d:"M15.5 15.5C15.5 16.3284 14.8284 17 14 17H10C9.17157 17 8.5 16.3284 8.5 15.5V8.5H15.5V15.5Z", stroke:"currentColor", strokeWidth:"1.5", strokeLinecap:"round", strokeLinejoin:"round"}),
        React.createElement('path', {d:"M15.5 12.25H12.625C11.9455 12.25 11.375 11.6795 11.375 11V8.5", stroke:"currentColor", strokeWidth:"1.5", strokeLinecap:"round", strokeLinejoin:"round"})
    )
);

export const PhindIcon = (props) => (
  React.createElement('svg', {...props, xmlns:"http://www.w3.org/2000/svg", viewBox:"0 0 24 24", fill:"currentColor"}, React.createElement('path', {d:"M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm-1 15v-4H8v-2h3V7h2v4h3v2h-3v4z"}))
);
