...
async function showShortcutToolbar(range, text, mouseX, mouseY) {
    ...
    try {
        ...
        let top = window.scrollY + mouseY + 8;
        let left = window.scrollX + mouseX - (toolbarRect.width / 2);

        // Boundary checks (keep left/right clamped; always keep toolbar below cursor)
