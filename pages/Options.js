             ...
             React.createElement('div', { className: "mb-8" },
                ...
                React.createElement('div', { className: "bg-black/50 p-8 rounded-lg flex justify-center items-center" },
                    React.createElement('div', { className: "bg-layer-01/90 backdrop-blur-sm rounded-lg shadow-lg p-0.5 flex flex-row gap-1 h-6" },
                        ...
                        React.createElement('div', { className: "w-px bg-border-strong/50 mx-0.5 my-1" }),
                        ...shortcuts.slice(0, 4).map(shortcut => (
                            React.createElement('button', { key: shortcut.id, title: shortcut.title, className: "group relative p-1 rounded-md text-text-secondary hover:bg-layer-hover/70 hover:text-text-primary transition-colors" },
                                React.createElement(Icon, { name: shortcut.icon, className: "w-4 h-4" })
                            )
                        )),
                        React.createElement('button', { title: "Manage Shortcuts...", className: "group relative p-1 rounded-md text-text-secondary hover:bg-layer-hover/70 hover:text-text-primary transition-colors" },
                            React.createElement(Icon, { name: "EllipsisHorizontalIcon", className: "w-4 h-4" })
                        )
                    )
                )
             ),
