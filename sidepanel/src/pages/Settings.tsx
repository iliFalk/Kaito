    ...
    <div className="p-4 h-full">
      ...
      <div className="mt-6 pt-4 border-t border-border-strong">
        ...
        <div className="p-4 bg-layer-01 rounded-lg border border-border-strong">
          ...
          <div className="space-y-3">
            <div>
              <label htmlFor="grain-amount-slider" className="flex justify-between items-center text-xs font-medium text-text-secondary mb-1">
                <span>Amount</span>
            ...
            <div>
              <label htmlFor="grain-size-slider" className="flex justify-between items-center text-xs font-medium text-text-secondary mb-1">
                <span>Size</span>
            ...
            <div>
              <label htmlFor="grain-roughness-slider" className="flex justify-between items-center text-xs font-medium text-text-secondary mb-1">
                <span>Roughness</span>
